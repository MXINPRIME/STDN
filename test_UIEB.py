...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default='./checkpoint/underwater-20221122-192807/090000.pt')
    ...
    parser.add_argument("--train_list", type=str, default=r'data/list/UIEB_test.txt')
    parser.add_argument('--save', type=str, default=r'checkpoint', help='method of test')
    ...
    vgg = VGGFeature()
    vgg.load_state_dict(torch.load(r'pretrain\vggfeature.pth'))
    vgg = vgg.eval().cuda()
